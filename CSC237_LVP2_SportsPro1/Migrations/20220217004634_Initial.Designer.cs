...
namespace CSC237_LVP2_SportsPro1.Migrations
{
    ...
    [Migration("20220217004634_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CSC237_LVP2_SportsPro1.Models.Country", b =>
                {
            ...
            modelBuilder.Entity("CSC237_LVP2_SportsPro1.Models.Customer", b =>
                {
            ...
            modelBuilder.Entity("CSC237_LVP2_SportsPro1.Models.Incident", b =>
                {
            ...
            modelBuilder.Entity("CSC237_LVP2_SportsPro1.Models.Product", b =>
                {
                    b.Property<int>("ProductID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CSC237_LVP2_SportsPro1.Models.Technician", b =>
                {
                    b.Property<int>("TechnicianID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CSC237_LVP2_SportsPro1.Models.Customer", b =>
                {
                    b.HasOne("CSC237_LVP2_SportsPro1.Models.Country", "Country")
                        .WithMany()
            ...
            modelBuilder.Entity("CSC237_LVP2_SportsPro1.Models.Incident", b =>
                {
                    b.HasOne("CSC237_LVP2_SportsPro1.Models.Customer", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CSC237_LVP2_SportsPro1.Models.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProductID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CSC237_LVP2_SportsPro1.Models.Technician", "Technician")
                        .WithMany()
